...
// For instance:
// - Hero: "Life Time Studio helps developers launch startups fast"
// - Problem Agitation: "Developers spend too much time adding features, get overwhelmed, and quit." (not about Life Time Studio at all)
// - Features: "Life Time Studio has user auth, Stripe, emails all set up for you"
const Problem = () => {
  return (
